...
export default function ChatScreen() {
    ...
    useEffect(() => {
        ...
        socket.onopen = () => {
            ...
            socket.send(JSON.stringify({ action: "sendMessage", username: "mohammad", message: "Hello from the client!" }));
        };
            ...
            >
                <View style={{borderWidth: 1, borderColor: 'red', height: '50%', width: '80%', minHeight: 100}}>
                    <ScrollView ref={scrollViewRef}>
                        ...
                        {
                            messages.map((msg, index) => (<ChatMessage key={index} user={msg.username || ""} message={msg.message} />))
                        }
                    </ScrollView>
                </View>
                <View style={{borderWidth: 1, borderColor: 'blue', width: '80%', minHeight: '5%', height: '5%', flexDirection: 'row'}}>
                    <TextInput onChangeText={setMessageInput} value={messageInput} style={{width: '80%', height: '100%', color: 'white', borderWidth: 1, borderColor: 'green'}} />
                    <Pressable 
                        style={{width: '20%', height: '100%', borderWidth: 1, borderColor: 'purple'}}
                        onPress={sendMessage}
                    >
