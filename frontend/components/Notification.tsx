...
export function Notification(props: NotificationProps) {
    ...
    return (
        <View style={{flex: 1, flexDirection:'row', width: '92%', /*borderColor: 'red', borderWidth: 1,*/ alignSelf: 'center', marginVertical: 8}}>
            ...
            <View style={{flexBasis:'67.4%', flex: 1, justifyContent: 'center'}}>
                ...
                <View style={{margin: '1%', paddingTop: '2%'}}>
                    <Text>I lost this item at the ECSS around 7 PM coming into class.</Text>
                </View>
            </View>
            
            <View style={{flexBasis: '18.2%', justifyContent:'center', alignItems: 'flex-end'}}>
                <Image 
                source={props.image}
